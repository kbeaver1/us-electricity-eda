...
This report has analyzed the past 10 years of daily spot price data for Palo Verde Peak and discovered that daily

# Code

```{r setup, include=FALSE, message=FALSE, warning=FALSE, echo=FALSE, results='asis'}
...
```{r import weather dataset, message=FALSE, warning=FALSE}

weather_data <- read.csv ("./Data/weather_dataset.csv")


```

## Import Electricity Hub Datasets (2014-2024) 

```{r 2014-2015, message=FALSE, warning=FALSE, results='asis'}
...
```{r head, include=FALSE, message=FALSE, warning=FALSE, echo=FALSE, results='asis'}
...
```{r combined dataset, include=FALSE, message=FALSE, warning=FALSE, echo=FALSE, results='asis'}
...
```{r plots, include=FALSE, message=FALSE, warning=FALSE, echo=FALSE, results='asis'}
...
```{r hidden characters, include=FALSE, message=FALSE, warning=FALSE, echo=FALSE, results='asis'}
