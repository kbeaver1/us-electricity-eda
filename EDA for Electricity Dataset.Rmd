...
This report was created as background research in applying for an business internship with the Tucson Electric Power (TEP) company in 2024. To understand more about the commodity price environment that TEP operates in, I 

I found daily spot price data from 2014-2024 for the 

The [Intercontinental Exchange (ICE)](https://www.theice.com/index) provided the U.S. Energy Information Administration selected wholesale daily spot price data from 2001-2024 (<https://www.eia.gov/electricity/wholesale/>) for 8 electricity hubs:
