...
I discovered that spot prices are highly correlated with changes in temperature and energy consumption, which is how the electric industry has always operated and planned for changes in cash flow, but in one rare case I discovered that TEP's revenues were affected most over 10-year time span by an $84 million dollar Power Purchase Agreement in June 2021 affected short-term sales for the Palo Verde Peak (PVP), one of the largest electric hubs within TEP's electric system. The figure below represents the change in PVP spot prices from June 1-30, 2021. 



Resources: 

[Intercontinental Exchange (ICE)](https://www.theice.com/index)

U.S. Energy Information Administration (<https://www.eia.gov/electricity/wholesale/>)

(<https://www.sec.gov/ix?doc=/Archives/edgar/data/100122/000010012222000020/tep-20211231.htm>)


I found daily spot price data from 2014-2024 for the 

The  provided the U.S. Energy Information Administration selected wholesale daily spot price data from 2001-2024 (<https://www.eia.gov/electricity/wholesale/>) for 8 electricity hubs:
...
After analyzing the past 10 years of daily spot price data for Palo Verde Peak and discovered that spot prices are correlated with changes in temperature and energy consumption, as all hubs has always been affected by these factors, but Palo Verde was significantly affected by a Power Purchase Agreement (PPA).
...
ggplot(pvp_june_2021, aes(x = `Trade date`, y = Change)) +
  ...
  labs(title = "Palo Verde Peak spot prices from June 1 - 30, 2021",
       x = "",
       y = "Spot Price") +
  theme_minimal() +
...
ggsave("images/spot_price_plot.png", width = 8, height = 5, dpi = 300)
